...
export const LAYER_REGISTRY: LayerInfo[] = [
  ...
  { id: 'sidewalks', label: 'Allowed sidewalks (green)', status: 'live', dataset: 'DS-041', feeds: 'Real sidewalk polygons minus exclusions — East Village pilot' },
  { id: 'hydrant', label: 'Fire hydrants (10 ft buffer)', status: 'live', dataset: 'DS-036', feeds: '§10 step 5 — hydrant buffer (pilot; distance unverified)' },
  ...
  { id: 'commercial', label: 'C4/C5/C6 commercial zoning', status: 'illustrative', dataset: 'DS-012', feeds: '§10 step 3 — zoning exclusion (awaiting nyzd sidecars)' },
  ...
  { id: 'sidewalksCitywide', label: 'Allowed sidewalks beyond the pilot', status: 'pending', dataset: 'DS-041', feeds: 'Extend green areas citywide — needs vector tiles / spatial service' },
